...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h4>Update New CSR</h4>
                <div class="card" style="background-color: #fafafa;">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admincsr.update',$csr->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row mb-3">
                                <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Title</label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" class="form-control form-control-sm" placeholder="Enter Title" value="{{$csr->title}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="date" class="form-control form-control-sm" placeholder="Enter Date" {{$csr->date}}>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="user_id" class="form-select form-select-sm">
                                        <option value="{{$csr->user_id}}">choose an admin name...</option>
