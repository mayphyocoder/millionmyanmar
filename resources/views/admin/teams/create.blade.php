        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card" style="background-color: #fafafa;">
                    <div class="card-body">
                        <form method="POST" action="{{ route('adminteams.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="position" class="form-control form-control-sm" placeholder="Enter Position">
                                </div>
                            </div>
